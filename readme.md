# Défi Animation UI - Armand Petit

Ce repository est le résultat de ma participation au **défi Animation UI** d'Armand Petit sur LinkedIn.

## À propos du projet

Ce projet SwiftUI contient une animation UI créée dans le cadre du challenge proposé par Armand Petit. L'ensemble du code se trouve principalement dans un seul fichier (`ContentView.swift`) pour 299 lignes de code.

## Installation

⚠️ **Note importante** : Cloner ce projet complet serait plus compliqué que nécessaire. 

**Recommandation** : Il est plus simple de :
1. Créer un nouveau projet Xcode
2. Copier le contenu du fichier `ContentView.swift` dans votre nouveau projet

Cette approche vous évitera les complications liées aux dépendances et à la configuration du projet existant.

## Démo

Une vidéo de démonstration est disponible ici :
[Voir la démo](https://www.dropbox.com/scl/fi/lpo7gmaolet87ch2v2nwy/Enregistrement-de-l-cran-2025-05-31-17.42.28.mov?rlkey=k5gz9ylc55o8ndvzotddnpxjg&st=dx4bbhaf&dl=0)
...
*Merci à Armand Petit pour ce défi créatif !*
